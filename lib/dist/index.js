(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.easyroute = {}));
	...
	***************************************************************************** */
	...
	var transitionsCalculations = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.getTransitionDurations = void 0;

	function getTransitionDurations(transitionName) {
	    var enteringDuration = 0;
	    var leavingDuration = 0;
	    for (var i = 0; i < document.styleSheets.length; i++) {
	        var rules = tslib_es6.__spread(document.styleSheets[i]['rules']);
	        for (var k = 0; k < rules.length; k++) {
	            if (!rules[k]['selectorText'])
	                continue;
	            if (rules[k]['selectorText'].indexOf("." + transitionName + "-enter-active") !==
	                -1) {
	                var duration = rules[k]['style']['transitionDuration'];
	                enteringDuration = getDuration(duration);
	            }
	            if (rules[k]['selectorText'].indexOf("." + transitionName + "-leave-active") !==
	                -1) {
	                var duration = rules[k]['style']['transitionDuration'];
	...
	exports.getTransitionDurations = getTransitionDurations;
	    ...
	    if (duration.indexOf('ms') !== -1) {
	        if (duration.indexOf(',') !== -1) {
	            ...
	            durArray.sort(function (a, b) {
	                return (Number(b.trim().replace('ms', '')) -
	...
	unwrapExports(transitionsCalculations);
	var transitionsCalculations_1 = transitionsCalculations.getTransitionDurations;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.delay = exports.getTransitionDurations = void 0;

	var Router_1$1 = tslib_es6.__importDefault(Router_1);

	Object.defineProperty(exports, "getTransitionDurations", { enumerable: true, get: function () { return transitionsCalculations.getTransitionDurations; } });
	...
	var src_1 = src.delay;
	var src_2 = src.getTransitionDurations;

	exports.default = index;
	exports.delay = src_1;
	exports.getTransitionDurations = src_2;
