(function (global, factory) {
	...
	***************************************************************************** */
	...
	var Router = /** @class */ (function () {
	    ...
	    Router.prototype.downloadDynamicComponents = function (matchedRoutes) {
	                ...
	                switch (_a.label) {
	                    case 0:
	                        nonDynamic = matchedRoutes.map(function (route) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
	                            var isAsync, component, e_1;
	                            return tslib_es6.__generator(this, function (_a) {
	                                switch (_a.label) {
	                                    case 0:
	                                        isAsync = /(\.then)/i.test(route.component.toString());
	            ...
	            return tslib_es6.__generator(this, function (_c) {
	                switch (_c.label) {
	                    ...
	                    case 2:
	                        ...
	                        return [4 /*yield*/, this.downloadDynamicComponents(matched)];
	                    case 3:
	                        _b.apply(_a, [_c.sent()]);
