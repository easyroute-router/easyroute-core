(function (global, factory) {
	...
	***************************************************************************** */
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.uniqueByIdAndNestingDepth = void 0;
	...
	function uniqueByIdAndNestingDepth(routesArray) {
	    ...
	    var uniqueDepths = tslib_es6.__spread(new Set(routesArray.map(function (route) { return route.nestingDepth; })));
	    var uniqueById = uniqueIds.map(function (id) { return routesArray.find(function (route) { return route.id === id; }); });
	    return uniqueDepths.map(function (depth) { return uniqueById.find(function (route) { return route.nestingDepth === depth; }); });
	}
	exports.uniqueByIdAndNestingDepth = uniqueByIdAndNestingDepth;

	});

	unwrapExports(uniqueBy);
	var uniqueBy_1 = uniqueBy.uniqueByIdAndNestingDepth;

	var ParserService_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });



	var ParserService = /** @class */ (function () {
	    function ParserService(routes) {
	        this.routes = routes;
	    }
	    ParserService.prototype.parse = function (url) {
	        var _this = this;
	        ...
	        var unique = uniqueBy.uniqueByIdAndNestingDepth(allMatched);
	        if (!unique) {
	...
	var setHistoryMode_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.setHistoryMode = void 0;
	...
	unwrapExports(setHistoryMode_1);
	var setHistoryMode_2 = setHistoryMode_1.setHistoryMode;

	var setHashMode_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.setHashMode = void 0;
	...
	exports.setHashMode = setHashMode;

	});

	unwrapExports(setHashMode_1);
	var setHashMode_2 = setHashMode_1.setHashMode;

	var checkAsyncAndDownload_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.checkAsyncAndDownload = void 0;

	function checkAsyncAndDownload(component) {
	    return tslib_es6.__awaiter(this, void 0, void 0, function () {
	        var isAsync, newComponent, e_1;
	        return tslib_es6.__generator(this, function (_a) {
	            switch (_a.label) {
	                case 0:
	                    isAsync = /(\.then)/i.test(component.toString());
	                    if (!!isAsync) return [3 /*break*/, 1];
	                    return [2 /*return*/, component];
	                case 1:
	                    _a.trys.push([1, 3, , 4]);
	                    return [4 /*yield*/, component()];
	                case 2:
	                    newComponent = _a.sent();
	                    return [2 /*return*/, newComponent.default];
	                case 3:
	                    e_1 = _a.sent();
	                    console.warn("[Easyroute] caught an error while trying to download async component: \"" + e_1.message + "\"");
	                    return [2 /*return*/, component];
	...
	exports.checkAsyncAndDownload = checkAsyncAndDownload;

	});

	unwrapExports(checkAsyncAndDownload_1);
	var checkAsyncAndDownload_2 = checkAsyncAndDownload_1.checkAsyncAndDownload;

	var downloadDynamicComponents_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.downloadDynamicComponents = void 0;


	function downloadDynamicComponents(matchedRoutes) {
	    return tslib_es6.__awaiter(this, void 0, void 0, function () {
	        var nonDynamic;
	        var _this = this;
	        return tslib_es6.__generator(this, function (_a) {
	            switch (_a.label) {
	                case 0:
	                    nonDynamic = matchedRoutes.map(function (route) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
	                        var _a, _b, _c, component, _d, key, value, _e, _f, e_1_1;
	                        var e_1, _g;
	                        return tslib_es6.__generator(this, function (_h) {
	                            switch (_h.label) {
	                                case 0:
	                                    ...
	                                    _a = route;
	                                    return [4 /*yield*/, checkAsyncAndDownload_1.checkAsyncAndDownload(route.component)];
	                                case 1:
	                                    _a.component = _h.sent();
	                                    _h.label = 2;
	                                case 2:
	                                    if (!route.components) return [3 /*break*/, 15];
	                                    _h.label = 3;
	                                case 3:
	                                    _h.trys.push([3, 9, 10, 15]);
	                                    _b = tslib_es6.__asyncValues(Object.entries(route.components));
	                                    _h.label = 4;
	                                case 4: return [4 /*yield*/, _b.next()];
	                                case 5:
	                                    if (!(_c = _h.sent(), !_c.done)) return [3 /*break*/, 8];
	                                    component = _c.value;
	                                    _d = tslib_es6.__read(component, 2), key = _d[0], value = _d[1];
	                                    _e = route.components;
	                                    _f = key;
	                                    return [4 /*yield*/, checkAsyncAndDownload_1.checkAsyncAndDownload(value)];
	                                case 6:
	                                    _e[_f] = _h.sent();
	                                    _h.label = 7;
	                                ...
	                                case 10:
	                                    ...
	                                    if (!(_c && !_c.done && (_g = _b.return))) return [3 /*break*/, 12];
	                                ...
	                                case 15: return [2 /*return*/, route];
	                            }
	                        });
	                    }); });
	                    return [4 /*yield*/, Promise.all(nonDynamic)];
	                case 1: return [2 /*return*/, _a.sent()];
	            }
	        });
	    });
	}
	exports.downloadDynamicComponents = downloadDynamicComponents;

	});

	unwrapExports(downloadDynamicComponents_1);
	var downloadDynamicComponents_2 = downloadDynamicComponents_1.downloadDynamicComponents;

	var src = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	var PathService_1$1 = tslib_es6.__importDefault(PathService_1);
	var ParserService_1$1 = tslib_es6.__importDefault(ParserService_1);
	...
	var Router = /** @class */ (function () {
	    function Router(settings) {
	        ...
	        this.parser = new ParserService_1$1.default(this.routes);
	        setTimeout(function () {
	            _this.setParser();
	        }, 0);
	    }
	    Router.prototype.setParser = function () {
	        switch (this.mode) {
	            case 'silent':
	                ...
	                break;
	            case 'history':
	                setHistoryMode_1.setHistoryMode.apply(this);
	                break;
	            case 'hash':
	            default:
	                setHashMode_1.setHashMode.apply(this);
	                break;
	        }
	    };
	    Router.prototype.getTo = function (matched, url) {
	        var maxDepth = Math.max.apply(Math, tslib_es6.__spread(matched.map(function (route) { return route.nestingDepth; })));
	    ...
	    Router.prototype.getFrom = function () {
	        ...
	        var maxDepth = Math.max.apply(Math, tslib_es6.__spread(current.map(function (route) { return route.nestingDepth; })));
	    ...
	    Router.prototype.runAllIndividualHooks = function (matched, to, from) {
	        var matched_1, matched_1_1;
	        var e_1, _a;
	        return tslib_es6.__awaiter(this, void 0, void 0, function () {
	            var component, allow, e_1_1;
	            return tslib_es6.__generator(this, function (_b) {
	                switch (_b.label) {
	                    case 0:
	                        _b.trys.push([0, 6, 7, 12]);
	                        matched_1 = tslib_es6.__asyncValues(matched);
	                        _b.label = 1;
	                    case 1: return [4 /*yield*/, matched_1.next()];
	                    case 2:
	                        if (!(matched_1_1 = _b.sent(), !matched_1_1.done)) return [3 /*break*/, 5];
	                        component = matched_1_1.value;
	                        return [4 /*yield*/, this.executeBeforeHook(to, from, component.beforeEnter)];
	                    case 3:
	                        allow = _b.sent();
	                        if (!allow) {
	                    ...
	                    case 7:
	                        ...
	                        if (!(matched_1_1 && !matched_1_1.done && (_a = matched_1.return))) return [3 /*break*/, 9];
	                        return [4 /*yield*/, _a.call(matched_1)];
	                    case 8:
	                        _b.sent();
	                        _b.label = 9;
	    ...
	    Router.prototype.parseRoute = function (url, doPushState) {
	        if (doPushState === void 0) { doPushState = true; }
	        return tslib_es6.__awaiter(this, void 0, void 0, function () {
	            var matched, to, from, allowNextGlobal, allowNextLocal, allowNext, _a, _b;
	                ...
	                switch (_c.label) {
	                    case 0:
	                        ...
	                        if (this.mode === 'history' && url.includes('#'))
	                            url = url.replace('#', '');
	                        matched = this.parser.parse(url.split('?')[0]);
	                        if (!matched)
	                            return [2 /*return*/];
	                        ...
	                        return [4 /*yield*/, this.executeBeforeHook(to, from, this.beforeEach)];
	                    case 1:
	                        allowNextGlobal = _c.sent();
	                        return [4 /*yield*/, this.runAllIndividualHooks(matched, to, from)];
	                    case 2:
	                        allowNextLocal = _c.sent();
	                        allowNext = allowNextGlobal && allowNextLocal;
	                        if (!allowNext)
	                            return [2 /*return*/];
	                        this.changeUrl(PathService_1$1.default.constructUrl(url, this.base), doPushState);
	                        this.currentRouteData.setValue(to);
	                        _b = (_a = this.currentMatched).setValue;
	                        return [4 /*yield*/, downloadDynamicComponents_1.downloadDynamicComponents(matched)];
	                    case 3:
	                        _b.apply(_a, [_c.sent()]);
	    ...
	    Router.prototype.executeBeforeHook = function (to, from, hook) {
	        return tslib_es6.__awaiter(this, void 0, void 0, function () {
	            var _this = this;
	            return tslib_es6.__generator(this, function (_a) {
	                return [2 /*return*/, new Promise(function (resolve) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
	                        var next;
	                        var _this = this;
	                        return tslib_es6.__generator(this, function (_a) {
	                            switch (_a.label) {
	                                case 0:
	                                    ...
	                                    if (!!hook) return [3 /*break*/, 1];
	                                    resolve(true);
	                                    return [3 /*break*/, 3];
	                                case 1: return [4 /*yield*/, hook(to, from, next)];
	                                case 2:
	                                    _a.sent();
	                                    _a.label = 3;
