...
var PathParser_1 = __importDefault(require("../Services/PathParser"));
var Observable_1 = __importDefault(require("../Utils/Observable"));
var UrlParametersParser_1 = __importDefault(require("../Services/UrlParametersParser"));
...
var Router = /** @class */ (function () {
    ...
    Router.prototype.setParser = function () {
        ...
        switch (this.mode) {
            case 'silent':
                this.parser = new PathParser_1.default(this.routes);
    ...
    Router.prototype.getTo = function (matched, url) {
        ...
        return Object.freeze(UrlParametersParser_1.default.createRouteObject([currentRoute], url));
    };
